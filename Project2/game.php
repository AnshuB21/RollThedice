...
<body>
    ...
    <div class="headingDiv">
        <marquee behavior="scroll" direction="right">Two players. One goal. Countless possibilities!</marquee>
    </div>
    ...
    <?php else : ?>
        ...
        <div id="start-form-wrapper">
            ...
            <form id="start-form" action="game.php" method="get">
                ...
                <h1 class="blink">Two players. One goal. Countless possibilities.!
